...
public class Authentication implements Filter {
	private final String[] visibles = { "/Login", "/login.jsp",  "/index.jsp", "/register.jsp", "/Register", "/about.jsp","/doctor.jsp","/contact.jsp"};
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		boolean visibleURL = isVisible(reqURL) || reqURL.startsWith("/assets/");
		UserType type = null;
