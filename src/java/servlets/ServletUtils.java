...
public final class ServletUtils {
	...
	public static boolean isValidSpec(String spec) {
		return "pathologist".equalsIgnoreCase(spec) || "orthopedist".equalsIgnoreCase(spec) || "endocrinologist".equalsIgnoreCase(spec)
                        || "neurologist".equalsIgnoreCase(spec) || "psychiatrist".equalsIgnoreCase(spec) || "obstetrician".equalsIgnoreCase(spec)
                        || "gulmonologist".equalsIgnoreCase(spec) || "ophthalmologist".equalsIgnoreCase(spec) || "otolaryngologist".equalsIgnoreCase(spec);
	}
