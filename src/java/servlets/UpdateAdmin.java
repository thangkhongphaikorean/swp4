 ...
 * @author PC
 */
@WebServlet(name = "UpdateAdmin", urlPatterns = {"/admin/UpdateAdmin"})
public class UpdateAdmin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            suc= Accounts.updateAdmin(username, password, adminName, adminPhone,
                    adminEmail, adminDOB, adminAddress);
        } catch (SQLException ex) {
            Logger.getLogger(UpdateAdmin.class.getName()).log(Level.SEVERE, null, ex);
        }
    
          
        ServletUtils.showForm(request, response, suc?"Success! You cancel your appointment on ": "234234Error! please try again"+suc, "infoAdmin.jsp");
