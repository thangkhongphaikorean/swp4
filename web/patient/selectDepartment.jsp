...
<body>
	...
	<div class="page-section">
		<div class="container">
			...
			<form action="ShowDoctor" method="get" class="main-form">
				<div class="row mt-5">
					...
					<div class="col-12 py-2 wow fadeInUp"
						data-wow-delay="300ms">
							<select name="departement" id="departement" class="custom-select">
								...
								<option value="${pageContext.request.contextPath}/patient/ShowDoctor?spec=pathologist">Pathologist</option>	
								<option value="${pageContext.request.contextPath}/patient/ShowDoctor?spec=orthopedist">Orthopedist</option>																	
                                                                <option value="${pageContext.request.contextPath}/patient/ShowDoctor?spec=endocrinologist">Endocrinologist</option>
                                                                <option value="${pageContext.request.contextPath}/patient/ShowDoctor?spec=neurologist">Neurologist</option>
								<option value="${pageContext.request.contextPath}/patient/ShowDoctor?spec=psychiatrist">Psychiatrist</option>	
								<option value="${pageContext.request.contextPath}/patient/ShowDoctor?spec=obstetrician">Obstetrician</option>																	
                                                                <option value="${pageContext.request.contextPath}/patient/ShowDoctor?spec=gulmonologist">Gulmonologist</option>
                                                                <option value="${pageContext.request.contextPath}/patient/ShowDoctor?spec=ophthalmologist">Ophthalmologist</option>
								<option value="${pageContext.request.contextPath}/patient/ShowDoctor?spec=otolaryngologist">Otolaryngologist</option>	
