<%-- 
    Document   : about
    Created on : Jul 13, 2022, 4:51:36 PM
    Author     : PC
--%>
            ...
            <div class="row">
                ...
                <div class="col-md-4 py-3 wow zoomIn">
                    <div class="card-service">
                        ...
                        <p><span>FPT</span>-Health Protection</p>
                    </div>
                </div>
                <div class="col-md-4 py-3 wow zoomIn">
                    <div class="card-service">
                        ...
                        <p><span>FPT</span>-Health Pharmacy</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 wow fadeInUp">
                    <h1 class="text-center mb-3">Welcome to Your FPT-Hopital</h1>
                    <div class="text-lg">
                        <p>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-6 col-lg-4 wow zoomIn">
                            <div class="card-doctor">
                                ...
                                <div class="body">
                                    <p class="text-xl mb-0">Dr. Thai Hoa</p>
