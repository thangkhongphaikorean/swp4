<%-- 
    Document   : blog
    Created on : Jul 13, 2022, 4:50:42 PM
    Author     : PC
--%>
...
<body>
          ...
          <div class="collapse navbar-collapse" id="navbarSupport">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="${pageContext.request.contextPath}/doctors.jsp">Doctors</a>
                </li>
    ...
    <div class="page-section">
        <div class="container">
                            ...
                            <div class="card-blog">
                                <div class="header">
                                    ...
                                    <a href="blog-details" class="post-thumb">
                                        <img src="${pageContext.request.contextPath}/assets/img/blog/blog_1.jpg" alt="" />
                                    </a>
                                </div>
                                <div class="body">
                                    <h5 class="post-title">
                                        <a href="${pageContext.request.contextPath}/blog-details.jsp">List of Countries without Coronavirus case</a
                      >
                    </h5>
                    <div class="site-info">
                      <div class="avatar mr-2">
                        <div class="avatar-img">
                          <img src="${pageContext.request.contextPath}/assets/img/person/person_1.jpg" alt="" />
                        </div>
                  ...
                  <div class="header">
                    <div class="post-category">
                      <a href="#">Dental</a>
                                ...
                                <a href="blog-details" class="post-thumb">
                                    <img src="${pageContext.request.contextPath}/assets/img/blog/blog_3.jpg" alt="" />
                                </a>
                            </div>
                            <div class="body">
                                <h5 class="post-title">
                                    <a href="${pageContext.request.contextPath}/blog-details.jsp">What is the impact of eating too much sugar?</a
                      >
                    </h5>
                    <div class="site-info">
                      <div class="avatar mr-2">
                        <div class="avatar-img">
                          <img src="${pageContext.request.contextPath}/assets/img/person/person_4.jpg" alt="" />
                        </div>
                  ...
                  <div class="header">
                    <div class="post-category">
                      <a href="#">Covid19</a>
                        ...
                        <div class="body">
                            <h5 class="post-title">
                                <a href="${pageContext.request.contextPath}/blog-details.jsp">Shifting goalposts: Research in the time of the
                        coronavirus</a
                      >
                    </h5>
                    <div class="site-info">
                      <div class="avatar mr-2">
                        <div class="avatar-img">
                          <img src="${pageContext.request.contextPath}/assets/img/person/person_3.jpg" alt="" />
                        </div>
                  ...
                  <div class="header">
                    <div class="post-category">
                      <a href="#">Neurology</a>
                        ...
                        <a href="blog-details" class="post-thumb">
                            <img src="${pageContext.request.contextPath}/assets/img/blog/blog_4.jpg" alt="" />
                        </a>
                    </div>
                    <div class="body">
                        <h5 class="post-title">
                            <a href="${pageContext.request.contextPath}/blog-details.jsp">What are the nonmedical factors most closely linked to
                        death risk?</a
                      >
                    </h5>
                    <div class="site-info">
              ...
              <div class="col-sm-6 py-3">
                <div class="card-blog">
                  <div class="header">
                    ...
                    <a href="blog-details" class="post-thumb">
                        <img src="${pageContext.request.contextPath}/assets/img/blog/blog_5.jpg" alt="" />
                    </a>
                </div>
                <div class="body">
                    <h5 class="post-title">
                        <a href="${pageContext.request.contextPath}/blog-details.jsp">Do gut bacteria contribute to ethnic health
                        disparities</a
                      >
                    </h5>
                    <div class="site-info">
            ...
            <div class="body">
                <h5 class="post-title">
                    <a href="${pageContext.request.contextPath}/blog-details.jsp">The Recovery Room: News beyond the pandemic</a
                      >
                    </h5>
                    <div class="site-info">
                      <div class="avatar mr-2">
            ...
            <a href="blog-details" class="post-thumb">
                <img src="${pageContext.request.contextPath}/assets/img/blog/blog_2.jpg" alt="" />
            </a>
        </div>
        <div class="body">
            <h5 class="post-title">
                <a href="${pageContext.request.contextPath}/blog-details.jsp">Racism in mental healthcare: An invisible barrier</a
                      >
                    </h5>
                    <div class="site-info">
                      <div class="avatar mr-2">
    ...
    <div class="body">
        <h5 class="post-title">
            <a href="${pageContext.request.contextPath}/blog-details.jsp">COVID-19 live updates: Total number of cases passes
                        11.6 million</a
                      >
                    </h5>
                    <div class="site-info">
                      <div class="avatar mr-2">
                        <div class="avatar-img">
                          <img src="${pageContext.request.contextPath}/assets/img/person/person_2.jpg" alt="" />
                        </div>
